...
Plugin URI: http://netcrunched.com/plugins/all-in-one-webmaster/
...
<?=$show_sitemap?>
	 ...
	 <div id="side-info-column" class="inner-sidebar">
				<div class="postbox">
				  ...
				  <div class="inside">
	                <ul>
	                <li><a href="http://netcrunched.com/plugins/all-in-one-webmaster/" title="All in One Webmaster" target="_blank">Plugin Homepage</a></li>
	                </ul>
	              </div>
				</div>
     </div>
