...
Plugin URI: http://crunchmeme.com/plugins/all-in-one-webmaster/
...
function all_in_one_webmaster_head()
{
	...
	echo "<!-- All in one Webmaster by CrunchMeme.com - @CrunchMeme -->";
...
function all_in_one_webmaster_footer()
{
	...
	if (!($all_in_one_banner1 == 1))
	{
		...
		<small>Blog WebMastered by <a href="http://crunchmeme.com/plugins/all-in-one-webmaster/" target="_blank">All in One Webmaster</a>.</small></div>';
	}
...
function all_in_one_webmaster_options_page() {
   ...
   <div class=wrap>
    ...
    <p>
	  ...
	  /* 234x60, created 12/30/09 */
	  google_ad_slot = "4547514820";
	  google_ad_width = 234;
	  google_ad_height = 60;
	  //-->
	  </script>
	  ...
	  src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
		...
		<b><a href="http://wpplugins.com/plugin/167/all-in-one-webmaster-pro" target="_blank">Upgrade to PRO version v7.50</a> and get more options and support. Thank YOU.</b>
	</p>
	...
	<div style="float:left;width:63%;">
		...
		<h3>Webmaster Options</h3>
			...
			<tr valign="top">
				...
				<td>
				 <input name="all_in_one_fbinsights_webmaster" type="text" size="55" value="<?php echo get_option('all_in_one_fbinsights_webmaster'); ?>" /> <a href="http://www.facebook.com/insights/" target="_blank" title="Click to visit Facebook Insight"><?=$help_icon?></a> <i><a href="http://bit.ly/aioinsight" target="_blank">View Tutorial</a></i>
			...
			<div align="right"><code>Trouble finding META TAG? Visit: <a href="http://bit.ly/aiowebmaster" target="_blank"><font color="red">http://bit.ly/aiowebmaster</font></a></code></div>
		</div>
				...
				<h3>Automatic sitemap submission to Google, Bing, Yahoo and Ask.com</h3>
					...
					<tr valign="top" class="alternate">
							...
							<td>
								...
								<br />
								(example: http://crunchmeme.com/my/sitemap.xml)
							</td>
					</tr>
...
<?=$show_sitemap?>
	 ...
	 <div id="side-info-column" class="inner-sidebar">
				<div class="postbox">
				  ...
				  <div class="inside">
	                <ul>
	                <li><a href="http://crunchmeme.com/plugins/all-in-one-webmaster/" title="All in One Webmaster" target="_blank">Plugin Homepage</a></li>
	                <li>
			...
			<div id="side-info-column" class="inner-sidebar">
				<div class="postbox">
				  ...
				  <div class="inside">
					...
					<li>1) <a href="http://crunchmeme.com/plugins/twitter-goodies/" title="Twitter Goodies" target="_blank">Twitter Goodies</a></li>
					<li>2) <a href="http://crunchmeme.com/plugins/wp-google-buzz/" title="WP Google-buzz" target="_blank">WP Google-buzz</a></li>
  ...
  <div id="side-info-column" class="inner-sidebar">
	 	 				<div class="postbox">
	 	 				  <h3 class="hndle"><span>Thanks for all your support</span></h3>
	 	 				  <div class="inside">
	 	 	                <ul>
