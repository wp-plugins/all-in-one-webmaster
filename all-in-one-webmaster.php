...
function all_in_one_webmaster_footer()
{
	...
	echo '<a title="Web Analytics" href="http://getclicky.com/'.$clicky_an.'"><img alt="Web Analytics" src="http://static.getclicky.com/media/links/badge.gif" border="0" /></a>'."\n";
	...
	echo '<noscript><p><img alt="Clicky" width="1" height="1" src="http://static.getclicky.com/'.$clicky_an.'ns.gif" /></p></noscript>'."\n";
...
function all_in_one_webmaster_options_page() {
	...
	$help_icon = '<img border="0" src="'.$siteurl.'/wp-content/plugins/all-in-one-webmaster/help.gif" /> ';
	...
	<div style="float:left;width:60%;">
		...
		<h3>Webmaster Options</h3>
			...
			<tr valign="top" class="alternate">
				...
				<td>
				 <input name="all_in_one_google_webmaster" type="text" size="55" value="<?php echo get_option('all_in_one_google_webmaster'); ?>" /> <a href="http://www.google.com/webmasters/" target="_blank" title="Click to visit Google Webmaster Central"><?=$help_icon?></a><br />(only content value)<br />
			...
			<tr valign="top">
				...
				<td>
				 <input name="all_in_one_bing_webmaster" type="text" size="55" value="<?php echo get_option('all_in_one_bing_webmaster'); ?>" /> <a href="http://www.bing.com/webmaster/" target="_blank" title="Click to visit Bing Webmaster Center"><?=$help_icon?></a><br />(only content value)<br />
			...
			<tr valign="top" class="alternate">
				...
				<td>
				 <input name="all_in_one_yahoo_webmaster" type="text" size="55" value="<?php echo get_option('all_in_one_yahoo_webmaster'); ?>" /> <a href="http://siteexplorer.search.yahoo.com/" target="_blank" title="Click to visit Yahoo Site Explorer"><?=$help_icon?></a><br />(only content value)
				</td>
			</tr>
			</table>
		...
		<form method="post" mame="info_update2" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
			...
			<div class="postbox">
							<h3>Automatic sitemap submission to Google, Bing, Yahoo and Ask.com</h3>
								...
								<tr valign="top" class="alternate">
										<th scope="row" style="width:29%;"></th>
										<td>
	 ...
	 <div id="side-info-column" class="inner-sidebar">
				<div class="postbox">
				  ...
				  <div class="inside">
					...
					<li><a href="http://arpitshah.com/plugins/" title="My more plugins" target="_blank">My Other WP Plugins</a></li>
	                </ul>
	              </div>
				</div>
     </div>
