...
Description: All in One Webmaster allow you to add Google, Bing, Yahoo Webmaster Meta Tag into Header of your theme and also you can add Google Analytics into theme footer. Please go to <code>Settings -> All in One Webmaster</code> to authenticate your site.
Version: 0.9.2
Author: Arpit Shah
	...
	<div style="float:left;width:60%;">
		...
		<div class="postbox">
				<h3>Automatic sitemap submission to Google, Bing, Yahoo and Ask</h3>
					...
					<tr valign="top" class="alternate">
							<th scope="row" style="width:25%;"><label>Stay Tuned (in a month or so)</label></th>
