...
function all_in_one_webmaster_footer()
{
	...
	// Please don't remove this line. This is Trial Version. Get Pro Version and Respect/Support Author's work. Thank YOU.
...
function all_in_one_webmaster_options_page() {
   ...
   <div class=wrap>
    ...
    <p>
		<b><a href="http://wpplugins.com/plugin/167/all-in-one-webmaster-pro" target="_blank">Upgrade to PRO version</a> and get more options and support. Thank YOU.</b>
	</p>
...
<?=$show_sitemap?> <div align="right"> Brought to you by <a href="http://arpitshah.com" target="_blank">Arpit Shah</a> | <b><a href="http://wpplugins.com/plugin/167/all-in-one-webmaster-pro" target="_blank">PRO version</a></b></div>
   			</form>

	</div>
	 <div id="side-info-column" class="inner-sidebar">
				<div class="postbox">
				  <h3 class="hndle"><span><font color="red">PRO Version Released</font></span></h3>
				  <br>
				  <div align="center"><b><a href="http://wpplugins.com/plugin/167/all-in-one-webmaster-pro" target="_blank">Get PRO version here</a></b></div>
				  <br>
				  <div class="inside">
				  <b>Upgrade to PRO version to get lots of more options, support and simplify your WebMaster Work.</b>
				  <br>
				  <br>
				  <div align="center"><b><font color="red">Thank YOU..</font></b></div>
                  </div>
				</div>
     </div>
