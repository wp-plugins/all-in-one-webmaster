			...
			<tr valign="top">
				...
				<td>
					...
					<tr valign="top" class="alternate">
						...
						<td>
							 <input name="all_in_one_placed_mobile_only" type="checkbox"<?php if(get_option('all_in_one_placed_mobile_only')!='-1') echo 'checked="checked"'; ?> value="1" /> &nbsp;&nbsp;<code>Check</code> if you have selected ONLY Web version. (Default: unchecked)<br>
							 unchecked = Web + Mobile <br>
							 checked = ONLY Web
							 <br>
							 <br>
							 <input name="all_in_one_placed_tag_type" type="checkbox"<?php if(get_option('all_in_one_placed_tag_type')!='-1') echo 'checked="checked"'; ?> value="1" /> &nbsp;&nbsp;<code>Check</code> if you have selected Custom Domain. (Default: unchecked)<br>
