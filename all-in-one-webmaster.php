	...
	<div style="float:left;width:60%;">
		...
		<h3>Analytics Options</h3>
			...
			<tr valign="top" class="alternate">
				...
				<td>
				<textarea rows="5" cols="75" name="all_in_one_google_analytics"><?php echo htmlentities(get_option('all_in_one_google_analytics')); ?></textarea><br />(example : only content value)<br />
