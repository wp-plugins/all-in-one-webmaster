...
Description: Sitemap Submission option to Google, Yahoo, Bing and Ask.com. Also allow you to add Google, Bing, Yahoo Webmaster Meta Tag into your blog theme and also you can add Google Analytics using just an Account ID. Please go to <code>Settings -> All in One Webmaster</code> to authenticate your site.
Version: 0.9.5
Author: Arpit Shah
...
function all_in_one_webmaster_options_page() {
	...
	if (isset($_POST['info_update2']))
	{
		...
		else
		{
				...
				if ($statusTag == 'DONE') {
					$icon = '<img border="0" src="'.$siteurl.'/wp-content/plugins/all-in-one-webmaster/yes.jpg" /> ';
					$alter_link = '<br />';
					}
				else if ($statusTag == 'NOPE') {
					$icon = '<img border="0" src="'.$siteurl.'/wp-content/plugins/all-in-one-webmaster/fail.jpg" /> ';
	...
	<div style="float:left;width:60%;">
		...
		<h3>Webmaster Options</h3>
			...
			<tr valign="top" class="alternate">
					<th scope="row" style="width:25%;"><label>Google WebMaster Central</label></th>
				<td>
				 <input name="all_in_one_google_webmaster" type="text" size="55" value="<?php echo get_option('all_in_one_google_webmaster'); ?>" /> <a href="http://www.google.com/webmasters/" target="_blank">(?)</a><br />(only content value)<br />

				</td>
			</tr>
			<tr valign="top">
					<th scope="row" style="width:25%;"><label>Bing WebMaster Center</label></th>
				<td>
				 <input name="all_in_one_bing_webmaster" type="text" size="55" value="<?php echo get_option('all_in_one_bing_webmaster'); ?>" /> <a href="http://www.bing.com/webmaster/" target="_blank">(?)</a><br />(only content value)<br />

				</td>
			</tr>

			<tr valign="top" class="alternate">
					<th scope="row" style="width:25%;"><label>Yahoo Site Explorer</label></th>
				<td>
				 <input name="all_in_one_yahoo_webmaster" type="text" size="55" value="<?php echo get_option('all_in_one_yahoo_webmaster'); ?>" /> <a href="http://siteexplorer.search.yahoo.com/" target="_blank">(?)</a><br />(only content value)<br />
		...
		<h3>Analytics Options</h3>
			...
			<tr valign="top" class="alternate">
					<th scope="row" style="width:25%;"><label>Google Analytics</label></th>
				<td>
					<input name="all_in_one_google_analytics" type="text" size="55" value="<?php echo get_option('all_in_one_google_analytics'); ?>" /> <a href="http://www.google.com/analytics/" target="_blank">(?)</a>
		...
		<form method="post" mame="info_update2" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
			...
			<div class="postbox">
							<h3>Automatic sitemap submission to Google, Yahoo and Ask.com</h3>
								<div>
								<table class="form-table">

								<tr valign="top" class="alternate">
										<th scope="row" style="width:25%;"><label>Please provide existing Sitemap URL</label></th>
										<td>
								...
								<tr valign="top" class="alternate">
										...
										<td>
											(Currently Bing/Live Sitemap submission has some issues. Working on this)
										</td>
								</tr>
								...
								<div class="submit">
									<input type="submit" name="info_update2" class="button-primary" value="<?php _e('Submit to Google, Yahoo, Ask'); ?> &raquo;" />
