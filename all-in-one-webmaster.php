...
Description: 1) Sitemap Submission option to Google, Yahoo, Bing and Ask.com. 2) Options to add Google, Bing, Yahoo, Alexa, Blogcatalog Webmaster Meta Tag. 3) Options to add Google, Quantcast.com, GetClicky.com, Compete.com Analytics scripts for your blogs. Please go to <code>Settings -> All in One Webmaster</code> for more and detailed options.
Version: 6.2.5
Author: Arpit Shah
