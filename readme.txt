...
Tags: all in one webmaster, arpitshah, arpit, google webmaster, yahoo webmaster, bing webmaster, google analytics, meta tag generator, header, meta, footer, yahoo site explorer, Clicky, getClicky, 103Bees, compete.com, analytics, meta tag, Alexa, Alexa rank, BlogCatalog, Blog Catalog, Headers, Header, Footers, Footer, header and footer, header-footer, SiteMeter Analytics, Facebook, Facebook Insights
...
* Google, Yahoo, Bing, Alexa Ranks (new), BlogCatalog (new), Facebook Insights 

**Analytics Option for**

* Google, Quantcast (new), GetClicky, Compete.com (new), SiteMeter.com 
...
* Minor tweaks and better performance
* Have a suggestion? New feature request? Submit your request here: `http://arpitshah.com/plugins/all-in-one-webmaster/`

= 6.5.5 =
* Are you using Facebook Like or Facebook Share button? Do you want to track clicks/share/like on your own domain?
* Facebook Insights meta tag option added. Visit this for more info: `http://bit.ly/bvlQYj`
* Admin UI changes

= 6.2.5 =
* Another most requested SiteMeter Analytics option added
