...
**[Upgrade to PRO Version v7.1x](http://wpplugins.com/plugin/167/all-in-one-webmaster-pro)**
...
`2) Option to Exclude login user's click/hit to get accurate analytics.`
`3) No branding in footer and advertisement.`
`4) 5 More Webmaster Options will be added soon.`
...
* Header/Footer section will be remove as its not widely used.
...
* 5 More Webmaster Options will be added soon.
