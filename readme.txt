...
* Please report all you bug on Plugin <a href="http://bit.ly/all-in-one-webmaster" target="_blank">Homepage</a>. NOTE: This is very simple plugin with out any complicated code. It adds your requested meta tags into header and java script code to footer of your blog. You are most welcome to advise on any improvement. I created this plugin as of my personal interest only. 
