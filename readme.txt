...
* StatCounter Analytics Option (PRO version)
* Exclude Visits from login/admin user (PRO version)
* No branding and advertizement on blog (PRO version)
...
* Please visit http://wpplugins.com/plugin/167/all-in-one-webmaster-pro to get PRO version.
...
* Admin Page update.
* Readme file update.
* Pro Version Released.[Upgrade to PRO Version](http://wpplugins.com/plugin/167/all-in-one-webmaster-pro)
* Header/Footer section will remove soon as its not widely used.
* More other options will come soon. Please stay tuned.

= PRO Version Updates =
* Most popular StatCounter analytics option.
* Option to Exclude login user's click/hit to get accurate analytics.
* No branding in footer and advertisement.
...
* Please visit plugin home page for all detailed options
