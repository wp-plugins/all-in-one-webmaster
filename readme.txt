...
Tags: all in one webmaster, google webmaster, yahoo webmaster, bing webmaster, google analytics, meta tag generator, header, meta, footer, yahoo site explorer, Clicky, getClicky, 103Bees, compete.com, analytics, meta tag, Alexa, Alexa rank, BlogCatalog, Blog Catalog, Headers, Header, Footers, Footer, header and footer, header-footer, SiteMeter Analytics, Facebook, Facebook Insights, BuddyPress
...
**[Upgrade to PRO Version v7.50](http://bit.ly/get-webmaster-pro)**
...
* Please visit http://bit.ly/get-webmaster-pro to get PRO version.
...
* Please report all you bug on Plugin Homepage. NOTE: This is very simple plugin with out any complicated code. It adds your requested meta tags into header and java script code to footer of your blog. You are most welcome to advise on any improvement. I created this plugin as of my personal interest only. 
...
= 7.0.2 = 
* New: Now with Google Site Speed Tracking code.
* <a href="http://crunchmeme.com/plugins/all-in-one-webmaster/" target="_blank">Changelog</a>

= 7.0.1 and previous =
* Tested and Checked the compatibility with 3.1-Beta1 and 3.0.3.
* Admin page update.
* Changed Two Admin Panel link as plugin homepage moved to CrunchMeme.com
* Added [CrunchMeme Fan Page](http://www.facebook.com/CrunchMemeBlog) Like button to admin panel.
* Admin Page update.
...
= PRO Version Updates =
* [Upgrade to PRO Version](http://bit.ly/get-webmaster-pro)
