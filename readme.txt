...
Tags: all in one webmaster, arpitshah, arpit, google webmaster, yahoo webmaster, bing webmaster, google analytics, meta tag generator, header, meta, footer, yahoo site explorer, Clicky, getClicky, 103Bees, analytics, meta tag, Alexa, Alexa rank, BlogCatalog, Blog Catalog
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=10641755
Requires at least: 2.6	
Tested up to: 3.0
Stable tag: 4.5.5

1) Sitemap submission to Google,Bing,Yahoo & Ask. 2) Webmaster option for Google,Bing,Alexa,Yahoo & BlogCatalog. 3) Analytics option for Google,Quantcast,Clicky,103Bees.
...
3. Submit your sitemap to Google, Bing, Yahoo and Ask.com
...
= 3.5.0 =
* As per user's request `Alexa Rank` meta tag option added
* Fixed Yahoo meta tag closing tag bug
* Other minor bug fixes

= 2.2.0 =
* More cleaner code
* Compatible with Wordpress v3.0
* Lots of new requested webmaster options will come in next releases.

= 1.5.0 =
* Process improvement and bug fixes.

= 1.3.0 =
* Bug fix: Image loading issue for some users. Now using `get_bloginfo( 'wpurl' );` to get blog url.