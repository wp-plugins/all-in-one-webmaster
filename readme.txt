...
Sitemap submission option for Google, Bing, Yahoo & Ask. Webmaster option for Google, Bing, Alexa, Yahoo & BlogCatalog. Analytics option for Google, Clicky, 103Bees.
...
* `Alexa Rank` and `BlogCatalog` verification `meta tag` option added
...
3. Success/Fail result for sitemap submission
4. All in one Webmaster Admin page - 2
