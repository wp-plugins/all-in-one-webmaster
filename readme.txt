...
Tags: all in one webmaster, arpitshah, arpit, google webmaster, yahoo webmaster, bing webmaster, google analytics, meta tag generator, header, meta, footer, yahoo site explorer, Clicky, getClicky, 103Bees, analytics, meta tag, Alexa, Alexa rank, BlogCatalog, Blog Catalog, Headers, Header, Footers, Footer, header and footer, header-footer
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=10641755
Requires at least: 2.6	
Tested up to: 3.0
Stable tag: 5.1.5

Sitemap submission to Google,Bing,Yahoo & Ask. Webmaster option for Google,Bing,Alexa,Yahoo & BlogCatalog. Analytics option for Google,Quantcast,Clicky,103Bees.Header/Footer.
...
* Google, Quantcast (new), Clicky, 103Bees
